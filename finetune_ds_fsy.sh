...
MODEL="/cpfs01/shared/llm_ddd/lipeiji/hf_hub_1/models--Qwen--Qwen2.5-7B-Instruct/snapshots/bb46c15ee4bb56c5b63245ef50fd7637234d6f75"
...
torchrun $DISTRIBUTED_ARGS finetune_fsy.py \
    ...
    --data_path $DATA \
    --bf16 True \
    --output_dir /cpfs01/shared/llm_ddd/lipeiji/jennieGPT/ckpts/fsy_$now \
    --num_train_epochs 1 \
